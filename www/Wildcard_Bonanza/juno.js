...
function gameOver(winner) {
  ...
  if(winner === "player") {
    ...
    document.getElementById("gameOverMessage").innerHTML = "你贏了！";
    ...
    playerWinsImg.setAttribute("alt", "你贏了！");
  ...
  // Execute block if computer is the winner
    ...
    document.getElementById("gameOverMessage").innerHTML = "你輸了...";
    ...
    computerWinsImg.setAttribute("alt", "你輸了...");
    // Append image to game over div
